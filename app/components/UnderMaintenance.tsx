...
export default function UnderMaintenance({ title }: { title: string }) {
  ...
  const wrenchRef = useRef<HTMLSpanElement>(null);
  ...
  return (
    <main className="relative min-h-screen bg-[#064928] overflow-x-hidden">
      <section className="relative flex min-h-[38vh] sm:min-h-[42vh] flex-col justify-center gap-4 sm:gap-6
        bg-[#c2e0a5] px-5 sm:px-10 md:px-16 lg:px-24 py-16 overflow-hidden">
        <h1
          ref={heroRef}
      ...
      <section className="flex flex-col items-center justify-center px-4 py-16 sm:py-20 md:py-24 text-center min-h-[50vh]">
        <div
          ref={cardRef}
