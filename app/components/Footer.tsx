...
const SOCIAL_LINKS = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/technovitchennai/",
    icon: (
  ...
  {
    label: "GitHub",
    href: "https://github.com/technovit26",
    icon: (
  ...
  {
    label: "X / Twitter",
    href: "https://twitter.com/technovit",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-start md:justify-between gap-10 md:gap-6">
          ...
          <div className="flex flex-col gap-3 max-w-xs">
            <div className="flex items-center">
              <span className="font-clash font-bold text-xl tracking-widest uppercase text-white">
                technoVIT&apos;26
              </span>
            </div>
            <p className="text-[#84C87F]/80 text-xs sm:text-sm font-semibold uppercase tracking-[0.2em] mt-1">
              VIT Chennai Annual Tech Fest
            </p>
          ...
          <div className="flex flex-col gap-2">
            <span className="text-[10px] uppercase tracking-[0.25em] text-white/40 font-semibold mb-1">
              Pages
            </span>
            {NAV_LINKS.map((link) => (
              <Link
